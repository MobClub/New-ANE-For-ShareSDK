package cn.sharesdk.ane {
	...
	public class PlatformID {
		...
		public static const Pengyou:int = 9;			//Friends
		...
		public static const Tumblr:int = 17;			//Tumblr
		public static const Mail:int = 18; 				//Mail
		public static const SMS:int = 19;				//SMS
		public static const Print:int = 20; 			//Print
		public static const Copy:int = 21;				//Copy
		public static const WeChatSession:int = 22;		//WeChat Session
		public static const WeChatTimeline:int = 23;	//WeChat Timeline
		public static const QQ:int = 24;				//QQ
		public static const Instapaper:int = 25;		//Instapaper
		public static const Pocket:int = 26;			//Pocket
		public static const YouDaoNote:int = 27; 		//You Dao Note
		public static const SohuKan:int = 28; 			//Sohu Sui Shen Kan
		public static const Pinterest:int = 30; 		//Pinterest
		public static const Flickr:int = 34;			//Flickr
